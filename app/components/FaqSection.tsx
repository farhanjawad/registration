...
const faqs = [
  {
    ...
    answer: (
      <span>
        নিবন্ধন ও পেমেন্ট সম্পন্ন হওয়ার পর আপনার ইমেইলে একটি ৬-ডিজিটের ভেরিফিকেশন কোড পাঠানো হবে। কোডটি স্বেচ্ছাসেবক ভাইকে দেখালেই আপনি বই সংগ্রহ করতে পারবেন। কোনো সমস্যা হলে আমাদের <Link href="/support" className="text-amber-600 font-bold hover:underline">সাপোর্ট পেজে</Link> যোগাযোগ করুন।
      </span>
    )
  },
  {
